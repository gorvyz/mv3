    ...
    */
    ...
    /* 
      TODO #8: Parse the response from the view request and create an object containing an array of 
            pending, completed, and active streams using the givendata. Return the new object.
    ...
    */
    ...
    data[1]?.forEach((key: number, value: any) => {
      let stream: Stream = {
        ...
        recipient: data[0][key],
        amountAptFloat: data[3][key] / 100_000_000,
                          ...
                          .sort((a, b) => {
                            switch (sort) {
                              ...
                              case Sort.ClaimableAmountHighToClose:
                                ...
                                b.props.amountAptFloat - b.props.amountAptFloat;

                              case Sort.ClaimableAmountCloseToHigh:
                                // TODO: Sort streams by claimable amount close to high
                                a.props.amountAptFloat - b.props.amountAptFloat;
